...
function ResponsiveDrawer(props) {
    ...
    const drawer = (
        <div style={df_jfs_ac_fdc}>
            ...
            <List>
                <ListItem disablePadding onClick={() => navigate('/dashboard')} sx={url.includes('dashboard') ? { color: '#375EC0' } : { color: "#6A707F" }}>
                    <ListItemButton>
                        <ListItemIcon>
                            <Icon color={url.includes('dashboard') ? '#375EC0' : '#6A707F'} icon="ic:round-dashboard" width={26} height={26} />
                        </ListItemIcon>
