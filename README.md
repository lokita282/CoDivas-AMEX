...
<div align="center">
  ...
  <div>
  <h1 fontSize="500">Hello Everyone 👋🏻 </h1>
...
eZ-RUPI : ✨Empowering Seamless Transactions, the eZ-RUPI Way!✨
## Project Description
...
- [Usage](#usage)
- [Features](#features)
- [Demo or Screenshots](#demo-or-screenshots)
...
1. Clone the project repository: `https://github.com/lokita282/CoDivas-AMEX`
...
- Generate eRupi <br>
    Generate digital vouchers for efficient and secure transactions.
...
- QR Scanning<br>
    Scan QR codes to quickly redeem the coupons.
- SMS Scanning<br>
...
The link to API Documentation :- https://documenter.getpostman.com/view/16934299/2s93sabZGr
